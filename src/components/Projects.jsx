      ...
      <div className="">
        <div className="grid grid-cols-1 pb-8 text-center">
          ...
          <p className="text-slate-400 max-w-xl mx-auto">
            Our ready-made digital solutions are perfect to streamline our
            business processes and can be tailored to the unique needs of your
            project. Giving you the perfect space to grow and conquer.
          </p>
        </div>
