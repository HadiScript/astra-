        ...
        <div className="lg:col-span-7 md:col-span-6 mt-14 md:mt-0">
          <div className="lg:ms-5">
            ...
            <p className="my-dim-text max-w-xl">
              We are a dynamic and forward-thinking software house dedicated to
              providing cutting-edge digital solutions. With a passion for
              technology and a commitment to excellence, we strive to exceed our
