...
const Home = () => {
  ...
  return (
    <>
        ...
        <div className="container z-1">
          <div className="grid grid-cols-1 text-center relative">
            <h4 className="lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 font-bold text-white">
              Astra Analytica <br /> Providing you with futuristic digital
              solutions
            </h4>
            <p className="text-slate-400 text-lg max-w-xl mx-auto">
              taking your business to the next level with our dynamic approach.
            </p>
                ...
                <div className="lg:col-span-10 mt-8">
                  <div className="lg:col-span-4 md:col-span-5">
                    <div className=" relative z-1">
                      <Link
                        to="/about"
                        className="btn bg-primary hover:bg-primary border-primary dark:border-primary text-white rounded-md"
                      >
                        Explore More
                      </Link>
                      <Link
                        to="/contact"
                        className="btn bg-primary/5 hover:bg-primary border-primary/10 hover:border-primary text-primary text-white rounded-md ms-2"
                      >
                        Contact Us
                      </Link>
                    </div>
      ...
      <section
        className="py-20 w-full table relative bg-[url('../../assets/images/hero/bg2.jpg')] bg-top bg-no-repeat bg-cover"
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 text-center">
            ...
            <p className="text-white/80 max-w-xl mx-auto">
              Embark on an exciting journey and discover the endless
              possibilities of our innovative solutions. With Astra Analytica by
              your side, you can unlock new horizons and unleash the true
              potential of your business. Don't wait any longer – take the first
              step towards success and explore our cutting-edge services now.
            </p>
            <div className="d-flex" id="reserve-form">
              <div className="md:w-5/6 mx-auto">
                <div className="lg:col-span-10 mt-8">
                  <div className="lg:col-span-4 md:col-span-5">
                    <div className=" relative z-1">
                      ...
                      <Link
                        to="/contact"
                        className="btn bg-primary/5 hover:bg-primary border-primary/10 hover:border-primary text-white hover:text-white rounded-md ms-2"
                      >
                        Contact Us
                      </Link>
                    </div>
