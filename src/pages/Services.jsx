...
export default function Services() {
  ...
  const accordionData = [
    {
      title:
        " How does Astra Analytica handle data security and confidentiality?",
      content:
        "Astra Analytica takes data security and confidentiality seriously. We implement robust security measures to safeguard your sensitive information throughout the development process. Our team adheres to strict data protection protocols, including secure coding practices, access controls, and encryption techniques. Additionally, we are open to signing non-disclosure agreements (NDAs) to provide an additional layer of confidentiality and protection.",
    },
    {
      title: "Can Astra Analytica handle both small and large-scale projects?",
      content:
        "Absolutely. At Astra Analytica, we can handle projects of varying sizes and complexities. Whether you have a small-scale project with specific requirements or a large-scale, enterprise-level solution, we have the expertise and resources to accommodate your needs. Our flexible approach allows us to tailor our services to match the scope and scale of your project.",
    },
    {
      title:
        "How does Astra Analytica ensure effective communication throughout the project?",
      content:
        "Effective communication is crucial for successful project execution. At Astra Analytica, we prioritize clear and transparent communication channels with our clients. We provide regular updates on project progress, conduct frequent meetings and discussions, and are responsive to your inquiries and feedback. We utilize various communication tools and platforms to ensure seamless collaboration, regardless of geographical location or time zone differences.",
    },
  ];
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                  <div className="lg:col-span-8 md:col-span-7">
                    <div className="ltr:md:text-left rtl:md:text-right text-center relative z-1">
                      ...
                      <p className="text-slate-400 max-w-xl">
                        Discover more about our software house and the
                        exceptional solutions we provide. Explore our expertise,
                        values, and commitment to delivering innovative software
