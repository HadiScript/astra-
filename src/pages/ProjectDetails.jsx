            ...
            <div className="lg:col-span-8 md:col-span-6">
              ...
              <ul className="list-none mt-5">
                {findedOne.tech.map((x, index) => (
                  <li
                    key={index}
                    className="inline-flex items-center py-2 px-4 bg-white dark:bg-slate-900 me-2 my-1 shadow dark:shadow-gray-700 rounded-md"
                  >
                    <div className="">
              ...
              {findedOne.para3 && (
                <p className="text-slate-400 mt-4">{findedOne.para3}</p>
              )}
              ...
              <ul className="list-none">
                {findedOne.features.map((x, index) => (
                  <li key={index} className="text-slate-400 mt-2">
                    <i className="uil uil-arrow-right text-emerald-600 me-1">
                      {x}
                    </i>
                  </li>
                ))}
                  ...
                  <div className="lg:col-span-8 md:col-span-7">
                    <div className="ltr:md:text-left rtl:md:text-right text-center relative z-1">
                      ...
                      <p className="text-slate-400 max-w-xl">
                        ...
                        possibilities of our innovative solutions. With
                        Infinititech by your side, you can unlock new horizons
                        and unleash the true potential of your business. Don't
                        wait any longer – take the first step towards success
                        and explore our cutting-edge services now.
                      </p>
                    </div>
                  </div>
